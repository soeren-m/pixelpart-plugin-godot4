...
public:
	...
	/**
	 * @brief Whether the effect is flipped horizontally.
	 */
	bool flip_h;

	/**
	 * @brief Whether the effect is flipped vertically.
	 */
	bool flip_v;
#endif
	...
	/**
	 * @brief Set whether the effect is flipped horizontally.
	 *
	 * @param flip Flipped
	 */
	...
	/**
	 * @brief Set whether the effect is flipped vertically.
	 *
	 * @param flip Flipped
	 */
	...
	/**
	 * @brief Return whether the effect is flipped horizontally.
	 *
	 * @param flip Flipped
	 */
	...
	/**
	 * @brief Return whether the effect is flipped vertically.
	 *
	 * @param flip Flipped
	 */
