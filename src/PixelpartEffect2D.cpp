...
pixelpart::EffectInputSet::iterator PixelpartEffect2D::findInput(String name) {
...
pixelpart::EffectInputSet::const_iterator PixelpartEffect2D::findInput(String name) const {
	std::string inputName = std::string(name.utf8().get_data());
