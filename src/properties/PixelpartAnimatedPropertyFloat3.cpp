...
void PixelpartAnimatedPropertyFloat3::init(pixelpart::AnimatedProperty<pixelpart::vec3_t>* prop, pixelpart::ParticleEngine* engine) {
	property = prop;
...
void PixelpartAnimatedPropertyFloat3::refresh_solver() {
	if(particleEngine) {
