...
void PixelpartStaticPropertyInt::init(pixelpart::StaticProperty<pixelpart::int_t>* prop, pixelpart::ParticleEngine* engine) {
	property = prop;
...
void PixelpartStaticPropertyInt::refresh_solver() {
	if(particleEngine) {
