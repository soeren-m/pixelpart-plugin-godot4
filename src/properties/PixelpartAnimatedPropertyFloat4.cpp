...
void PixelpartAnimatedPropertyFloat4::init(pixelpart::AnimatedProperty<pixelpart::vec4_t>* prop, pixelpart::ParticleEngine* engine) {
	property = prop;
...
void PixelpartAnimatedPropertyFloat4::refresh_solver() {
	if(particleEngine) {
