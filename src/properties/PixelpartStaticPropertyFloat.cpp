...
void PixelpartStaticPropertyFloat::init(pixelpart::StaticProperty<pixelpart::float_t>* prop, pixelpart::ParticleEngine* engine) {
	property = prop;
...
void PixelpartStaticPropertyFloat::refresh_solver() {
	if(particleEngine) {
