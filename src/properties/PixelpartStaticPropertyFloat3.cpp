...
void PixelpartStaticPropertyFloat3::init(pixelpart::StaticProperty<pixelpart::vec3_t>* prop, pixelpart::ParticleEngine* engine) {
	property = prop;
...
void PixelpartStaticPropertyFloat3::refresh_solver() {
	if(particleEngine) {
