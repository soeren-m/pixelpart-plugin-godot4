...
void PixelpartAnimatedPropertyInt::init(pixelpart::AnimatedProperty<pixelpart::int_t>* prop, pixelpart::ParticleEngine* engine) {
	property = prop;
...
void PixelpartAnimatedPropertyInt::refresh_solver() {
	if(particleEngine) {
