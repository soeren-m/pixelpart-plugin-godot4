...
void PixelpartAnimatedPropertyFloat2::init(pixelpart::AnimatedProperty<pixelpart::vec2_t>* prop, pixelpart::ParticleEngine* engine) {
	property = prop;
...
void PixelpartAnimatedPropertyFloat2::refresh_solver() {
	if(particleEngine) {
