...
void PixelpartAnimatedPropertyFloat::init(pixelpart::AnimatedProperty<pixelpart::float_t>* prop, pixelpart::ParticleEngine* engine) {
	property = prop;
...
void PixelpartAnimatedPropertyFloat::refresh_solver() {
	if(particleEngine) {
